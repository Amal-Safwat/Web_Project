      ...
      <?php
        if (Login::isLoggedIn()) 
        {
            ...
            if($type == 2)
            {
              ...
              print "<a href='myads.php'><div class='item'><i class='fas fa-percentage'></i> Ads </div></a>";
              // print "<a href='myads.php'><div class='item'><i class='fas fa-percentage'></i> مصمم</div></a>";
            }
